"""Alpha101 and Alpha158 factor analysis on the point-in-time S&P 500, from WRDS CRSP daily bars.
...
file; edit them and run ``uv run python examples/wrds_us_equity/sp500_factor_analysis.py``
or step through the ``# %%`` cells. Prerequisite: the stores written by
``scripts/wrds/index.py --index sp500`` under the data root
(see README.md).
"""
