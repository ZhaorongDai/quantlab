"""XGB-TD (pytabkit) pipeline on the point-in-time Nasdaq-100, from WRDS CRSP daily bars.
...
QQQ, logged to Weights & Biases.

Every setting is a constant or a quantlab config object at the top of the
file; edit them and run ``uv run python examples/wrds_us_equity/nasdaq100_xgb_td.py``
