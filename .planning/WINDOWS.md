...
fixed_count: 10
total_count: 31
last_updated: 2026-09-23T05:14:26.539Z
---
...
| 4 | quick-260906-13w | unrun-verify | quantlab/dataset/_support/masking.py |  | UniverseMask.report() not run against real membership vs real us_all market data; a non-empty missing-member list would falsify D-07 | open |  | 2026-09-06T05:16:52.451Z |  |
...
| 30 | 03.12 | unmet-truth | quantlab/dataset/crsp/__init__.py | 717 | backward anchor: a dlyret of -1.0 AFTER the anchor row no longer trips _assert_anchor_usable and zeroes the whole adjusted tail (CR-01 harm through a new door); pinned by tests/test_crsp_dataset.py::test_a_total_loss_after_the_anchor_is_not_refused_and_zeroes_the_tail | open |  | 2026-09-23T03:42:59.222Z |  |
| 31 | 03.12 | unrun-verify | tests/test_crsp_rebuild_measurements.py |  | 真实数据门 test_the_real_store_reproduces_its_adjusted_columns 已写入但未执行：操作者选 B（重建推迟），盘上 store 的 adj* 仍由 .last() 锚算出，与代码不一致；重建后必须跑这条门 | open |  | 2026-09-23T05:14:26.539Z |  |
...
[
  ...
  },
  {
    ...
    "kind": "unrun-verify",
    "phase": "quick-260906-13w",
    "file": "quantlab/dataset/_support/masking.py",
    "line": null,
  ...
  },
  {
    ...
    "kind": "deviation",
    "phase": "03.5",
    "file": "quantlab/acquisition/_support/inspector.py",
    "line": 99,
  ...
  },
  {
    ...
    "kind": "unmet-truth",
    "phase": "03.12",
    "file": "quantlab/dataset/crsp/__init__.py",
    "line": 717,
    "description": "backward anchor: a dlyret of -1.0 AFTER the anchor row no longer trips _assert_anchor_usable and zeroes the whole adjusted tail (CR-01 harm through a new door); pinned by tests/test_crsp_dataset.py::test_a_total_loss_after_the_anchor_is_not_refused_and_zeroes_the_tail",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-23T03:42:59.222Z",
    "resolved_at": null
  },
  {
    "id": 31,
    "kind": "unrun-verify",
    "phase": "03.12",
    "file": "tests/test_crsp_rebuild_measurements.py",
    "line": null,
    "description": "真实数据门 test_the_real_store_reproduces_its_adjusted_columns 已写入但未执行：操作者选 B（重建推迟），盘上 store 的 adj* 仍由 .last() 锚算出，与代码不一致；重建后必须跑这条门",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-23T05:14:26.539Z",
    "resolved_at": null
  }
]
````
