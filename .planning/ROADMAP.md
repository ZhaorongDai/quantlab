...
- [ ] 03.8-04-PLAN.md — Red-green palette for the heatmap and the monthly bars (green = gain, red = loss, grey at zero, zmid=0 kept, blank cells kept), one shared set of colour constants, hue-direction and cross-panel colour locks
