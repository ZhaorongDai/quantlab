...
**Depends on:** Phase 3
**Plans:** 16/18 plans executed (4 UAT gap-closure plans pending)
...
- [ ] 03.7-17-PLAN.md — G-03.7-9: `load()` refuses a checkpoint trained on other or reordered factors/labels (keyed on `trained_on`); the backtester delegates
