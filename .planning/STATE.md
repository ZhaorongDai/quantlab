...
- _(none open. Todo `2026-09-07-rebuild-universe-parquet-after-ticker-reconciliation` was opened and closed the same day — the rebuild needs no API key, contrary to what it was filed saying; see the closing note in `.planning/todos/completed/`.)_
